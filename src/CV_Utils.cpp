...
#if 1
GL::Texture2D matToTexture(const cv::Mat &mat, GLenum minFilter, GLenum magFilter, GLenum wrapFilter) {
	GL::Texture2D texture;
	PixelStorage storage;
	storage.setAlignment((mat.step & 3) ? 1 : 4)
		.setRowLength(mat.rows)
		.setImageHeight(mat.cols);
